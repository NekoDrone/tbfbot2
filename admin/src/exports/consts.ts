...
const ADMIN_USERS_COLLECTION: string = process.env.ADMIN_USERS_COLLECTION ?? "undefinde";
...
export const adminUsersCollection = firestoreObject.collection(ADMIN_USERS_COLLECTION);
